...
2. Download the .mat data files from [this link](https://huggingface.co/datasets/avathrasher/SONICData/tree/main) and place them in the +sonic/+data folder within your local repository.
