classdef LommelSeeliger < sonic.Reflectance
    ...
    methods
        ...
        function obj = LommelSeeliger(AL_ss)
            ...
            %   References:
            %       - Lommel-Seeliger Law
            %           https://ui.adsabs.harvard.edu/abs/2005JRASC..99...92F
            ...
            switch inputType
                case "ien"
                    ...
                    if ((size(u_i, 2) == size(obj.AL_ss, 2) && size(obj.AL_ss, 1) == 1) || all(size(obj.AL_ss) == [1, 1]))
                        ...
                        % Calculate cosine of i,e angles needed for BRDF
                        [cosi, cose] = obj.calcCosIE(u_i, u_e, u_n);

                    else
                        error('sonic:LommelSeeliger:invalidInput', ...
